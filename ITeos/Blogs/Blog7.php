    ...
    <div class="container mt-5 mb-5">
      <div class="row">
        ...
        <div class="left col-lg-8 col-md-12">
          <img
            class="img-fluid"
            src="../assets/images/Blogs/Procure-to.svg"
            alt="Blogs"
          />
          ...
          <div class="m-content mt-5">
            <h2 class="m-heading mb-5">Optimizing the Procure-to-Pay (P2P) Process for Business Efficiency</h2>
            ...
            <div class="list">
              <ol>
                ...
                <li>
                  <p>Better Supplier Relationships</p>
                  <p>
                ...
                <li>
                    <p>Increased Compliance & Risk Management</p>
                    <p>
                ...
                <li>
                    <p>Streamlined Communication Between Departments</p>
                    <p>
